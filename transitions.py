...
class TransitionMap:
    ...
    def add(self, event, new_state, tuple=tuple):
        """
    ...
    def add_set(self, event, new_set, tuple=tuple):
        """
    ...
    def split(self, code, len=len, maxint=maxsize):
        """
        ...
        while hi - lo >= 4:
            ...
            mid = ((lo + hi) // 2) & ~1 ## was mid = ((lo + hi) / 2) & ~1
            if code < map[mid]:
                hi = mid
            else:
                lo = mid
